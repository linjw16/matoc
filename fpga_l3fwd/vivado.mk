...
BD_TCL_FILES_REL = $(patsubst %, ../%, $(filter-out /% ./%,$(BD_TCL_FILES))) $(filter /% ./%,$(BD_TCL_FILES))
...
%.runs/impl_1/%_routed.dcp: %.runs/synth_1/%.dcp
	...
	echo "set_property strategy Congestion_SpreadLogic_high [get_runs impl_1]" >> run_impl.tcl
	echo "launch_runs -jobs $(JOBS) impl_1" >> run_impl.tcl
	echo "wait_on_run impl_1" >> run_impl.tcl
	vivado -nojournal -nolog -mode batch -source run_impl.tcl

# bit file
%.bit %.xsa: %.runs/impl_1/%_routed.dcp
